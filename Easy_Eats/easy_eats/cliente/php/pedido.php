...
<body>
    ...
    <img src="../ativos/imagens/logo2.png" alt="logo easy eats" class="logo">
        <h2 class="title">Pedidos solicitados</h2>
    </div>
            ...
            <div class="order">
                <div class="hashtag"><img src="../ativos/imagens/logo2.png" class="hashtag" alt="comida"></div>
                    <div class="pic-info card-body">
                        ...
                        <p class="card-text" name="valor"><?='Valor: R$ '.number_format($dados[2], 2, ',', '.'); ?>
                        <p class="card-text" name="cliente"><?= 'Cliente: '.$dados[5]; ?></p>
                
                 <form action="botoes.php" method="POST">
                         <input type="hidden" name="id_pedido" value="<?= $dados[0]; ?>">
                         <button name="deletar-pedido" class="btn btn-danger">Entregue</button>
                </form>
                    </div>
